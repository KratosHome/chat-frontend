...
export const ChannelDescription: React.FC<ChannelDescriptionPropsType> = memo(
   ({ currentChannel, placeholderName }) => {
      const [isModalOpenAddPeople, setIsModalOpenAddPeople] =
         useState<boolean>(false);
      const [isModalOpenDescription, setIsModalOpenDescription] =
         useState<boolean>(false);
      const [descriptionChannel, setDescriptionChannel] = useState<string>(
                  ...
                  <div className='description__content'>
                     ...
                     <div className='description__body'>
                        ...
                        <button
                           ...
                           onClick={() =>
                              setIsModalOpenDescription(!isModalOpenDescription)
                           }
                        >
                           Edit description
                        </button>
                     ...
                     <button
                        ...
                        onClick={() =>
                           setIsModalOpenAddPeople(!isModalOpenAddPeople)
                        }
                     >
