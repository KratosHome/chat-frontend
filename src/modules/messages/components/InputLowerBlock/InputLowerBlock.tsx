...
export const InputLowerBlock: FC<InputLowerBlockType> = memo(
   ({
      ...
      const [isHoverAttachments, setIsHoverAttachments] =
      ...
      const [isHoverMentionSomeone, setIsHoverMentionSomeone] =
         useState<boolean>(false);
      const [isHoverHideFormatting, setIsHoverHideFormatting] =
         useState<boolean>(false);
      const [isHoverSendMessage, setIsHoverSendMessage] =
         useState<boolean>(false);
      const [isHoverScheduleForLater, setIsHoverScheduleForLater] =
         useState<boolean>(false);
      ...
      return (
         <div className='containerLowerBlock'>
            <div className='containerLeftLowerBlock '>
               <button
                  onMouseOver={() => setIsHoverAttachments(true)}
                  onMouseOut={() => setIsHoverAttachments(false)}
               >
               ...
               <button
                  ...
                  onMouseOut={() => setIsHoverAudio(false)}
               >
                  <svg data-ufvi='true' viewBox='0 0 20 20'>
               ...
               <button
                  onMouseOver={() => setIsHoverEmoji(true)}
                  onMouseOut={() => setIsHoverEmoji(false)}
               >
                  <svg
                     className={
                        isHovering
               ...
               <button
                  onMouseOver={() => setIsHoverMentionSomeone(true)}
                  onMouseOut={() => setIsHoverMentionSomeone(false)}
               >
                  <svg data-ufvi='true' viewBox='0 0 20 20'>
                     <g fill='none' stroke='currentColor' strokeWidth='1.5'>
               ...
               <button
                  onMouseOver={() => setIsHoverHideFormatting(true)}
                  onMouseOut={() => setIsHoverHideFormatting(false)}
               >
                  <svg data-ufvi='true' viewBox='0 0 20 20'>
                     <g fill='none' stroke='currentColor' strokeWidth='1.5'>
                        <path
            ...
            >
               <button
                  onMouseOver={() => setIsHoverSendMessage(true)}
                  onMouseOut={() => setIsHoverSendMessage(false)}
               ...
               <button
                  onMouseOver={() => setIsHoverScheduleForLater(true)}
                  onMouseOut={() => setIsHoverScheduleForLater(false)}
               >
                  <svg
                     data-uqx='true'
                     viewBox='0 0 20 20'
