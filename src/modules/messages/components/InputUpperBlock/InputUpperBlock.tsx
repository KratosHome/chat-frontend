...
export const InputUpperBlock: FC<InputUpperBlockType> = memo(
    ({focusInput}) => {
        ...
        const [isHoverStrikethrough, setIsHoverStrikethrough] = useState<boolean>(false);
        const [isHoverLink, setIsHoverLink] = useState<boolean>(false);
        const [isHoverOrderedList, setIsHoverOrderedList] = useState<boolean>(false);
        const [isHoverBulletedList, setIsHoverBulletedList] = useState<boolean>(false);
        const [isHoverBlockquote, setIsHoverBlockquote] = useState<boolean>(false);
        ...
        return (
            ...
            >
                <button
                    onMouseOver={() => setIsHoverBold(!isHoverBold)}
                    onMouseOut={() => setIsHoverBold(!isHoverBold)}
                >
                ...
                <button
                    onMouseOver={() => setIsHoverItalic(!isHoverItalic)}
                    onMouseOut={() => setIsHoverItalic(!isHoverItalic)}
                >
                    <svg data-ufvi='true' viewBox='0 0 20 20'>
                        <g fill='none'>
                            <path
                ...
                <button
                    onMouseOver={() => setIsHoverStrikethrough(!isHoverStrikethrough)}
                    onMouseOut={() => setIsHoverStrikethrough(!isHoverStrikethrough)}
                >
                    <svg data-ufvi='true' viewBox='0 0 20 20'>
                        <g fill='none'>
                            <path
                ...
                <button
                    onMouseOver={() => setIsHoverLink(!isHoverLink)}
                    onMouseOut={() => setIsHoverLink(!isHoverLink)}
                >
                    ...
                    <svg data-ufvi='true' viewBox='0 0 20 20'>
                        ...
                        >
                            <path
                                d='m10 5 1.775-1.775a3.5 3.5 0 0 1 4.95 0l.05.05a3.5 3.5 0 0 1 0 4.95l-3.18 3.18a3.5 3.5 0 0 1-5.064-.121L8.5 11.25'></path>
                            <path
                                d='m10 15-1.775 1.775a3.5 3.5 0 0 1-4.95 0l-.05-.05a3.5 3.5 0 0 1 0-4.95l3.18-3.18a3.5 3.5 0 0 1 5.064.121l.031.034'></path>
                        </g>
                    </svg>
                </button>
                {
                ...
                <button
                    onMouseOver={() => setIsHoverOrderedList(!isHoverOrderedList)}
                    onMouseOut={() => setIsHoverOrderedList(!isHoverOrderedList)}
                >
                    <svg data-ufvi='true' viewBox='0 0 20 20'>
                        <g
                            fill='none'
                        ...
                        >
                            ...
                            ></path>
                            <path
                                d='m2 3 1.5-.5v4H2h3m-2.857 7.36A1.505 1.505 0 0 1 3.5 13c.828 0 1.25.672 1.25 1.25 0 .828-1.5 2-2.75 3.25h3'></path>
                        </g>
                    </svg>
                </button>
                {
                ...
                <button
                    onMouseOver={() => setIsHoverBulletedList(!isHoverBulletedList)}
                    onMouseOut={() => setIsHoverBulletedList(!isHoverBulletedList)}
                >
                    <svg data-ufvi='true' viewBox='0 0 20 20'>
                        <g fill='none'>
                            <path
                ...
                <button
                    onMouseOver={() => setIsHoverBlockquote(!isHoverBlockquote)}
                    onMouseOut={() => setIsHoverBlockquote(!isHoverBlockquote)}
                >
                    <svg data-ufvi='true' viewBox='0 0 20 20'>
                        <path
                            fill='none'
                ...
                <button
                    onMouseOver={() => setIsHoverCode(!isHoverCode)}
                    onMouseOut={() => setIsHoverCode(!isHoverCode)}
                >
                    <svg data-ufvi='true' viewBox='0 0 20 20'>
                        <g fill='none'>
                            <path
