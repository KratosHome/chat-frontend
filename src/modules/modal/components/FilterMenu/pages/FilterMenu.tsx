...
export const FilterMenu: React.FC<FilterMenuPropsType> = ({ onClose }) => {
   ...
   return (
      <div className='dark-modal-container filter'>
         <div className='dark-modal-container__header'>
            <div className='dark-modal-container__title'>
               ...
               <PopupIconButton
                  buttonAriaLabel={'Clear all fields'}
                  buttonClass={'filter__button-clear'}
                  buttonData={'tooltip_parent'}
                  buttonClick={() => clearInput!.forEach((el) => el(''))}
                  buttonMouseOver={() => setIsHoverClear(true)}
                  buttonMouseOut={() => setIsHoverClear(false)}
               >
                  <svg
         ...
         <div className='dark-modal-container__content'>
            <div className='dark-modal-container__content-container'>
               <FilterMenuItem
                  itemText={'Keywords'}
         ...
         <div className='dark-modal-container__footer'>
            ...
            <div className='dark-modal-container__footer-actions'>
               ...
               <PopupButton
                  buttonClass={'primary'}
                  buttonText={'Search'}
                  isButtonBlocked={isSearchButtonBlocked}
               />
            </div>
         </div>
         <PopupIconButton
