                    ...
                    <div className="categorySearchModal">
                            ...
                            <svg data-aqc="true" aria-hidden="true" viewBox="0 0 20 20">
                                <g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="1.5">
                                    ...
                                    <path stroke-linecap="round"
                                          d="M14 12.966a5.4 5.4 0 0 0 .75-.316l3 .6-.6-3A5.5 5.5 0 1 0 6.952 6.265"></path>
                                </g>
                            </svg>
                            <span>Messages</span>
                        </button>
                        <button>
                            <svg data-aqc="true" aria-hidden="true" viewBox="0 0 20 20">
                                <g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="1.5">
                                    <path
                                        d="M9.258 1.964a1.4 1.4 0 0 1 1.484 0l6.118 3.824a.84.84 0 0 1 0 1.424l-6.118 3.824a1.4 1.4 0 0 1-1.484 0L3.14 7.212a.84.84 0 0 1 0-1.424l6.118-3.824Z"></path>
                                    <path stroke-linecap="round"
                                          d="m17.26 10.463-6.52 4.074a1.397 1.397 0 0 1-1.482 0l-6.523-4.078"></path>
                                    <path stroke-linecap="round"
                                          d="m17.26 13.963-6.52 4.074a1.397 1.397 0 0 1-1.482 0l-6.523-4.078"></path>
                                </g>
                            </svg>
                            <span>Files</span>
                        </button>
                        ...
                        <button>
                            <svg data-aqc="true" aria-hidden="true" viewBox="0 0 20 20">
                                <g fill="none" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round"
                                          d="M6.23 9.25s-3.524.568-4.437 3.52c-.244.791.459 1.48 1.287 1.48h.221m2.929-5c-1.094-1.423-1.5-2.576-1.5-3.75 0-1.693 1.23-3.25 3.384-3.25.215 0 .42.014.616.04"></path>
                                    <path
                                        d="M18.137 15.803c.454 1.008-.502 1.947-1.607 1.947H7.47c-1.105 0-2.06-.94-1.607-1.947 1.013-2.25 3.8-3.053 6.137-3.053 2.338 0 5.124.803 6.137 3.053ZM15.25 8.438c0 2.795-1.771 4.312-3.25 4.312s-3.25-1.517-3.25-4.313c0-1.824 1.367-3.187 3.25-3.187s3.25 1.363 3.25 3.188Z"></path>
                                </g>
                            </svg>
                            <span>People</span>
                        </button>
