...
import { MenuUserStatusItemPropsType } from './MenuUserStatusItemType';

export const MenuUserStatusItem: React.FC<MenuUserStatusItemPropsType> = ({
   ...
   return (
      <div className='avatar-menu__user-status user-status'>
         <button
            ...
            onMouseOver={() => setFocusStatusButton(true)}
            onMouseOut={() => setFocusStatusButton(false)}
            onClick={() => {
               setIsModalSetStatusOpen(true);
