            ...
            <div className='widthMessageHeader'>
               <div className='containerCurrentChannel'>
                  ...
                  <div className='buttonCurrentChannel'>
                     ...
                     <button
                        onMouseOver={() =>
                           setIsHoverTelephone(!isHoverTelephone)
                        }
                        onMouseOut={() =>
                           setIsHoverTelephone(!isHoverTelephone)
                        }
                        className='callCurrentChannel'
                        disabled={true}
                     >
                        Start a Call
                     </button>
                  ...
                  <div className='tabsNameCurrentChannel'>
                     ...
                     <button
                        className={tab === 3 ? 'isTabsNameCurrentChannel' : ''}
                        onClick={() => setTab(3)}
                     >
                        Integrations
                     </button>
                     <button
                        className={tab === 4 ? 'isTabsNameCurrentChannel' : ''}
                        onClick={() => setTab(4)}
                     >
                        Settings
                     </button>
                  ...
                  <div className='tabsContainersCurrentChannel'>
                     ...
                     <Members tab={tab} setTab={setTab} />
                     <Integrations tab={tab} setTab={setTab} />
                     <Settings tab={tab} setTab={setTab} />
                  </div>
               </div>
            </div>
         </>
