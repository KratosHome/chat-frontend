...
export const Integrations: FC<IntegrationsType> = ({ tab, setTab }) => {
   return (
      <div
         className={tab === 3 ? 'containerMembers' : 'nowVisible'}
         onClick={() => setTab(3)}
      >
         <div className='containerIntegrations'>
            <div className='blockIntegrations'>
               <div>
                  ...
                  <span>
                     Automate the tasks and processes unique to your team, no
                     coding required.
                  </span>
            ...
            <div className='blockIntegrations'>
               <div>
                  ...
                  <span>
                     Bring the tools you need into this channel to pull reports,
