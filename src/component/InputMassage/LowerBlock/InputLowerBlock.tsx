                    ...
                    children={
                        <svg data-ufvi="true" viewBox="0 0 20 20">
                            <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5"
                                  d="M10 3.25v13.5M16.75 10H3.25"></path>
                        </svg>
                    }
                />
                <InputButton
                        ...
                        <svg data-ufvi="true" viewBox="0 0 20 20" className="">
                            <g fill="none" stroke="currentColor" stroke-width="1.5">
                                ...
                                <path stroke-linecap="round"
                                      d="M4.25 7.75V9A5.75 5.75 0 0 0 10 14.75v0A5.75 5.75 0 0 0 15.75 9V7.75m-5.75 7v2.75m2.25.25h-4.5"></path>
                            </g>
                        </svg>
                    }
                />
                                    ...
                                    <g fill="none">
                                         ...
                                         <circle cx="12.5" cy="8" r="1.5" fill="currentColor"></circle>
                                             <path fill="currentColor"
                                                   d="M10 14.961c1.43 0 2.86-.788 3.477-2.364.22-.56-.258-1.097-.86-1.097H7.383c-.602 0-1.08.537-.86 1.097.616 1.576 2.047 2.364 3.477 2.364Z"></path>
                                    </g>
                                 </svg>
                            </span>
                        }
