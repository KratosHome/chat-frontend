...
export const InputUpperBlock: FC<InputUpperBlockType> = memo(({focusInput}) => {
    ...
    return (
        <div
            className={focusInput ? "activeContainerInputUpperBlock containerInputUpperBlock" : "containerInputUpperBlock"}>
            <InputButton
                    ...
                    <svg data-ufvi="true" viewBox="0 0 20 20" className="">
                        <g fill="none">
                            <path stroke="currentColor" stroke-linecap="round" stroke-width="1.5"
                                  d="M7.75 2.75h7.5m-10.5 14.5h7.5"></path>
                            <path fill="currentColor" d="m7.5 17.5 3-15h2l-3 15h-2Z"></path>
                        </g>
                    </svg>
                }
            />
            ...
            <InputButton
                ...
                children={
                    <svg data-ufvi="true" viewBox="0 0 20 20" className="">
                        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke-width="1.5" d="M7.75 10.75h10m-10 6.5h10m-10-13h10"></path>
                            <path
                    ...
                    <svg data-ufvi="true" viewBox="0 0 20 20" className="">
                        <g fill="none">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                  stroke-width="1.5"
                                  d="M7.75 10h10m-10 7h10m-10-14h10"></path>
                ...
                children={
                    <svg data-ufvi="true" viewBox="0 0 20 20" className="">
                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5"
                              d="M2.75 2.75v14.5m4-13.5h8.5m-8.5 6.5h10.5m-10.5 6h7.5"></path>
                    </svg>
                }
            />
            <InputButton
