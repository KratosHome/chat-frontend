export default class MessageModel {
    ...
    constructor(id: number, participantId: number, text: string, timeStamp: number, isEdited: boolean, isRead: boolean, 
        chatChannelId: number, isUnderReview: boolean, sentTimeStamp:number, rejectedTimeStamp:number) {
        this.id = id; 
...
export class dateService {
    ...
    static getLocaleTime(messageModel:MessageModel) {
        const hours = String(this.getDate(messageModel).getHours()).padStart(2, "0");
        const minutes = String(this.getDate(messageModel).getMinutes()).padStart(2, "0");
